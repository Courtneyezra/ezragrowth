import { Phone, Star, Zap, Lightbulb, Plug, Power, Shield, Clock, CheckCircle, ArrowRight, AlertCircle, MapPin, Leaf, Package } from "lucide-react";
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12 lg:mb-16">
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
                        Commercial Electrical Specialists for <span className="text-rooketrade-cyan">Your Business</span>
                    </h2>
