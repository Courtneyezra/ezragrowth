...
export function IntakeHero({ location, headline, subhead, ctaText, mobileCtaText, desktopCtaText, bannerText, heroImage, onConversion, transparentBg }: IntakeHeroProps) {
  ...
  return (
    <>
      {bannerText && (
        <div className="bg-rooketrade-blue text-slate-900 text-center py-2 font-bold px-4">
        ...
        <div className="max-w-7xl mx-auto relative z-10 w-full">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left order-2 lg:order-1">
              {/* Trust a Trader #1 Badge */}
              <a
                href="https://www.trustatrader.com/traders/rooketrade-electrical-electricians-nottingham-south-west"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 bg-gradient-to-r from-amber-500/20 to-amber-600/10 px-4 py-2.5 rounded-full mb-6 backdrop-blur-sm border border-amber-500/30 w-fit mx-auto lg:mx-0 hover:border-amber-400/50 transition-colors group"
              >
                <div className="flex items-center gap-1">
                  <span className="text-amber-400 font-black text-lg">#1</span>
                  <span className="text-white/90 font-semibold text-sm">Rated Electrician</span>
                </div>
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-white/80 text-sm font-medium">4.96 <span className="text-white/60">on Trust a Trader</span></span>
                </div>
              </a>

              {/* Tick icon for mobile */}
              <div className="lg:hidden flex justify-center mb-6">
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-rooketrade-cyan to-rooketrade-blue flex items-center justify-center shadow-lg shadow-rooketrade-cyan/30">
              ...
              {(() => {
                ...
                const parseHeadline = (text: string | undefined) => {
                  if (!text) {
                    return {
                      tier1: location,
                      tier2: "Electrical Service",
                      tier3: "Next-day slots • NICEIC registered"
                    };
                  }
                  ...
                  <h1 className="font-poppins font-bold leading-[0.95] mb-6 max-w-3xl mx-auto lg:mx-0">
                    {parsedHeadline.tier2 ? (
                      ...
                      <>
                        ...
                        <span className="block text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-rooketrade-cyan mb-4 drop-shadow-lg">
                          {parsedHeadline.tier2}
                        </span>
              ...
              <div className="lg:hidden flex flex-col sm:flex-row gap-4 max-w-xl mx-auto mb-10 text-xl md:text-2xl">
                <Button
                  ...
                  onClick={() => {
                    ...
                    window.location.href = "tel:+447940354345";
                  }}
                  className="flex-1 py-4 lg:py-6 bg-rooketrade-cyan hover:bg-rooketrade-blue text-slate-900 font-bold rounded-full shadow-lg shadow-rooketrade-cyan/20 transition-transform hover:scale-105"
                >
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    window.open("https://wa.me/447940354345", "_blank");
                  }}
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 text-white/80">
                <div className="flex items-center gap-2">
                  <Clock className="w-5 h-5 text-rooketrade-cyan" />
                  <span>Next-day service</span>
                </div>
                <div className="flex items-center gap-2">
                  <MessageCircle className="w-5 h-5 text-rooketrade-cyan" />
                  <span>Quick response</span>
                </div>
                <div className="flex items-center gap-2">
                  <Shield className="w-5 h-5 text-rooketrade-cyan" />
                  <span>Fully insured</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-5 h-5 text-rooketrade-cyan" />
