            ...
            <div className="max-w-7xl mx-auto flex items-center justify-between">
                <Link href="/landing">
                    <div className="flex items-center gap-3 cursor-pointer" onClick={handleNavClick}>
                        ...
                        <span className="text-white font-bold text-lg md:text-xl">Rooketrade Electrical</span>
                    </div>
                </Link>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <a
                        ...
                        className="flex lg:hidden items-center gap-2 px-4 py-2 bg-rooketrade-cyan hover:bg-rooketrade-blue text-slate-900 font-semibold rounded-full transition-colors"
