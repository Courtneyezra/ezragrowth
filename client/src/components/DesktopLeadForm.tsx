        ...
        <div className="bg-slate-900/90 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-2xl max-w-lg w-full relative overflow-hidden group">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
                ...
                <Button
                    type="submit"
                    disabled={loading}
                    className="w-full h-14 text-xl font-bold rounded-xl bg-rooketrade-cyan hover:bg-rooketrade-blue text-slate-900 shadow-lg shadow-rooketrade-cyan/20 transition-all hover:scale-[1.02] active:scale-95"
                >
                ...
                <div className="text-center pt-4 border-t border-white/5 mt-4">
                    ...
                    <a href="tel:+447940354345" className="text-xl font-bold text-white tracking-wide hover:text-emerald-400 transition-colors">
                        07940 354 345
                    </a>
                </div>
            </form>
