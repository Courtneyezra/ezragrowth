                            ...
                            <div className="bg-slate-900 border-t border-x border-slate-700/50 rounded-t-lg px-3 py-1.5 pb-2.5 -mb-[1px] flex items-center gap-2 relative shadow-none">
                                <div className="flex flex-col items-end leading-none">
                                    <div className="flex gap-0.5 mb-1">
                                        {[1, 2, 3, 4, 5].map((i) => (
                                            <Star key={i} className="w-2.5 h-2.5 text-rooketrade-cyan fill-rooketrade-cyan" />
                                        ))}
                                    </div>
                        ...
                        {children ? (
                            ...
                            <div className="p-3 pb-4 flex gap-3">\
                                <Button
                                    ...
                                    className={`flex-1 py-3 font-bold rounded-xl text-sm flex items-center justify-center gap-2 ${isBookingMode ? 'bg-[#7DB00E] hover:bg-[#6da000] text-[#1D2D3D]' : 'bg-rooketrade-cyan hover:bg-rooketrade-blue text-slate-900'}`}
                                >
