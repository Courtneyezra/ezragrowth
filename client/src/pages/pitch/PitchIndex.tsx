                ...
                <CardHeader>
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <CardTitle className="text-white group-hover:text-yellow-400 transition-colors flex items-center gap-2">
                        {section.title}
        ...
        <Card className="bg-gradient-to-r from-yellow-500/20 to-green-500/10 border-yellow-500/30">
          <CardContent className="p-8">
            <div className="text-center mb-6">
              <p className="text-green-400 font-semibold mb-2">EARLY PARTNER OFFER</p>
              <h3 className="text-2xl font-bold text-white mb-2">
                £750 Landing Page + 1 Month FREE CRM Trial
              </h3>
              <p className="text-gray-300">
                Pay £62.50/mo for the page, try the full business system FREE for a month
              </p>
            </div>
