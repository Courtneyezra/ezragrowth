...
export default function CompetitorAnalysis() {
  const competitors = [
    ...
    },
    {
      ...
      strengths: ["Good GMB ranking", "Good reviews on GMB", "Trustatrader listing"],
          ...
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                You already have <strong>good GMB ranking</strong>, <strong>good reviews</strong>, and a <strong>Trustatrader listing</strong>.
                The only thing missing is a working website to convert those searchers into customers.
              </p>
              <div className="grid sm:grid-cols-4 gap-4 max-w-2xl mx-auto mb-8">
                <div className="text-center p-4 bg-gray-800/50 rounded-lg">
                  <CheckCircle className="h-8 w-8 text-green-500 mx-auto mb-2" />
                  <p className="text-sm text-gray-300">Good GMB</p>
                </div>
                <div className="text-center p-4 bg-gray-800/50 rounded-lg">
                  <CheckCircle className="h-8 w-8 text-green-500 mx-auto mb-2" />
                ...
                <div className="text-center p-4 bg-gray-800/50 rounded-lg">
                  <CheckCircle className="h-8 w-8 text-green-500 mx-auto mb-2" />
                  <p className="text-sm text-gray-300">Trustatrader</p>
                </div>
              ...
              <p className="text-xl text-white mb-6">
                Fix the website = <span className="text-yellow-400 font-bold">Complete the funnel</span>
              </p>
