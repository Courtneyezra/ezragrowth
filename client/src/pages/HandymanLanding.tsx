...
import { Phone, Star, Zap, Lightbulb, Plug, Power, Shield, Clock, CheckCircle, ArrowRight, AlertCircle, MapPin, Leaf, Package, Mic } from "lucide-react";
...
const WHATSAPP_NUMBER = "+447940354345";
const WHATSAPP_MESSAGE = encodeURIComponent("I'm interested in Rooketrade Electrical services");
const PHONE_NUMBER = "+447940354345";

import { LandingHeader } from "@/components/LandingHeader";
import { GoogleReviewsBadge } from "@/components/LandingShared";
import { TrustATraderSection } from "@/components/TrustATraderSection";
import { TrustATraderReviews } from "@/components/TrustATraderReviews";



function TeamSection() {
    const team = [
        { name: "James", role: "Lead Electrician", rating: "4.9/5", reviews: "80+ Reviews", specialty: "Domestic & Commercial", icon: <Zap className="w-5 h-5" />, image: teamMember1 },
        { name: "Marcus", role: "Senior Electrician", rating: "4.8/5", reviews: "50+ Reviews", specialty: "Rewiring Specialist", icon: <Lightbulb className="w-5 h-5" />, image: teamMember2 },
        { name: "Dan", role: "Electrician", rating: "4.8/5", reviews: "15+ Reviews", specialty: "EV & Smart Home", icon: <Plug className="w-5 h-5" />, image: teamMember3 },
    ];
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12 lg:mb-16">
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
                        Out of Many Locals, One <span className="text-rooketrade-cyan">Rooketrade Team</span>
                    </h2>
                    <p className="text-white/60 text-lg max-w-2xl mx-auto font-medium">
                        Meet our trusted electricians who've helped hundreds of Nottingham homeowners
                    </p>
                </div>
                ...
                <div className="grid grid-cols-3 gap-2 md:gap-8 lg:gap-12 items-stretch">
                    {team.map((member, idx) => (
                        <div key={idx} className="bg-slate-700/50 rounded-xl md:rounded-3xl p-2 md:p-8 text-center hover:bg-slate-700 transition-colors h-full flex flex-col">
                            ...
                            <div className="flex items-center justify-center gap-1 md:gap-2 text-rooketrade-cyan font-semibold mb-1 md:mb-2">
                            ...
                            <div className="bg-slate-800 rounded-lg md:rounded-xl p-2 md:p-4 mb-2 md:mb-4">
                                <p className="text-rooketrade-cyan font-bold text-sm md:text-2xl">{member.rating}</p>
...
function ProcessSection() {
    const steps = [
        ...
        { number: "2", title: "Electrician Checks", description: "We confirm availability and requirements", highlight: false },
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12 lg:mb-16">
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
                        <span className="text-rooketrade-cyan">Quicker & Faster</span>{" "}
                ...
                <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
                    {steps.map((step, idx) => (
                        <div
                            key={idx}
                            className={`relative p-8 lg:p-10 rounded-3xl text-center ${step.highlight ? "bg-rooketrade-cyan text-slate-900" : "bg-white text-slate-800"
                                }`}
                        >
                            <div className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 text-3xl font-bold ${step.highlight ? "bg-slate-800 text-rooketrade-cyan" : "bg-slate-100 text-slate-800"
                                }`}>
                                {step.number}
                            </div>
...
function VideoQuoteSection() {
    return (
        <section className="bg-rooketrade-cyan px-4 lg:px-8 py-16 lg:py-24">
            <div className="max-w-7xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div className="order-2 lg:order-1">
                        <div className="relative rounded-3xl overflow-hidden max-w-xl shadow-2xl">
                            <img
                                src={videoQuoteImage}
                                alt="Rooketrade Electrical technician talking with customer"
...
function ServicesSection() {
    const services = [
        { name: "Socket Installation", price: "£89", description: "Singles, doubles, USB sockets", icon: <Plug className="w-10 h-10" />, bgColor: "bg-blue-400" },
        { name: "Lighting", price: "£79", description: "Pendants, spotlights, dimmers", icon: <Lightbulb className="w-10 h-10" />, bgColor: "bg-rooketrade-blue" },
        { name: "Fuse Box", price: "£450", description: "Consumer unit upgrades", icon: <Zap className="w-10 h-10" />, bgColor: "bg-green-400" },
        { name: "EV Chargers", price: "£POA", description: "Home charging points", icon: <Power className="w-10 h-10" />, bgColor: "bg-purple-400" },
    ];
    ...
    return (
        <section id="services" className="bg-white px-4 lg:px-8 py-16 lg:py-24">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12 lg:mb-16">
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
                        <span className="text-rooketrade-cyan">Instant Quotes</span>{" "}
                        <span className="text-slate-800">For Big & Small Jobs</span>
                    </h2>
                    <p className="text-slate-600 text-lg font-medium">Professional electrical services at transparent prices</p>
                </div>
                ...
                <div className="text-center mt-16">
                    <a href="#hero" className="scroll-smooth">
                        <Button
                            className="px-10 py-6 bg-rooketrade-cyan hover:bg-rooketrade-blue text-slate-900 font-bold rounded-full text-lg"
...
function RealJobsSection() {
    const customers = [
        { name: "Sarah", area: "NG7", job: "Full house rewire", image: realJobToilet },
        { name: "Mike", area: "NG2", job: "Consumer unit upgrade", image: realJobPainting },
        { name: "Emily", area: "NG1", job: "EV charger installation", image: realJobSink },
        { name: "Linda", area: "NG4", job: "Kitchen lighting", image: realJobShelf },
        { name: "Craig", area: "NG7", job: "Garden office electrics", image: realJobKitchen },
        { name: "David", area: "NG3", job: "Smart home setup", image: realJobBlinds },
    ];
                        ...
                        <div key={idx} className="bg-slate-700 rounded-2xl overflow-hidden group hover:bg-slate-600 transition-colors">
                            ...
                            <div className="p-6">
                                <p className="text-white font-bold text-lg">
                                    {customer.name}, <span className="text-rooketrade-cyan">{customer.area}</span>
                                </p>
...
function BeforeAfterSection() {
    return (
        <section className="bg-rooketrade-blue px-4 lg:px-8 py-16 lg:py-24">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12 lg:mb-16">
                ...
                <div className="grid lg:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white rounded-3xl overflow-hidden shadow-xl">
                        <div className="p-6">
                            <span className="inline-block bg-rooketrade-cyan text-slate-900 font-bold px-4 py-1 rounded-full text-sm mb-4">After</span>
                            <div className="aspect-video bg-slate-100 rounded-2xl overflow-hidden">
                                <img
                                    src={afterImage}
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div className="lg:order-1">
                        <div className="relative rounded-3xl overflow-hidden max-w-xl shadow-2xl">
                            <img
                                src={payIn3Image}
                                alt="Rooketrade Electrical van with Pay in 3 badge"
                                className="w-full h-auto object-contain"
                            />
                        </div>
                    </div>
                    ...
                    <div className="lg:order-2 text-center lg:text-left">
                        ...
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
                            Pay in 3 <span className="text-rooketrade-cyan">Interest-Free</span> Payments
                        </h2>
                        ...
                        <div className="grid sm:grid-cols-3 gap-4 mb-8">
                            <div className="bg-slate-800 rounded-2xl p-4 text-center">
                                <p className="text-rooketrade-cyan font-bold text-2xl mb-1">1st</p>
                                <p className="text-white/60 text-sm">Pay deposit to book</p>
                            </div>
                            <div className="bg-slate-800 rounded-2xl p-4 text-center">
                                <p className="text-rooketrade-cyan font-bold text-2xl mb-1">2nd</p>
                                <p className="text-white/60 text-sm">Pay on job day</p>
                            </div>
                            <div className="bg-slate-800 rounded-2xl p-4 text-center">
                                <p className="text-rooketrade-cyan font-bold text-2xl mb-1">3rd</p>
                        ...
                        <a href="#hero" className="scroll-smooth">
                            <Button
                                className="w-full sm:w-auto px-10 py-6 bg-rooketrade-cyan hover:bg-rooketrade-blue text-slate-900 font-bold rounded-full text-lg"
...
function GuaranteesSection() {
    const guarantees = [
        ...
        { icon: <Zap className="w-6 h-6" />, title: "NICEIC registered electricians", subtitle: "All work certified" },
        ...
        <section className="bg-slate-100 px-4 lg:px-8 py-16 lg:py-24">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12 lg:mb-16">
                    ...
                    <p className="text-slate-600 text-lg">What you can expect from Rooketrade Electrical</p>
                </div>

                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {guarantees.map((guarantee, idx) => (
                        <div key={idx} className="bg-white rounded-2xl p-6 text-center shadow-sm hover:shadow-md transition-shadow">
                            <div className="w-14 h-14 bg-rooketrade-cyan rounded-2xl flex items-center justify-center mx-auto mb-4 text-slate-900">
                                {guarantee.icon}
                            </div>
            ...
            <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="flex items-center justify-center gap-2 mb-8">
                    ...
                    <div className="flex items-center gap-0.5">
                        {[...Array(5)].map((_, i) => (
                            <Star key={i} className="w-4 h-4 fill-rooketrade-cyan text-rooketrade-cyan" />
                        ))}
                    </div>
                ...
                <div className="border-t border-white/10 pt-8">
                    <p className="text-white/40 text-sm">
                        © 2024 Rooketrade Electrical Nottingham. All rights reserved.
                    </p>
                </div>
            </div>
        </section>
                ...
                <div className="grid lg:grid-cols-2 gap-8 items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <p className="text-white/90 text-lg mb-6">
                            Power outages, circuit faults, or sparking? We offer same-day emergency service for urgent electrical repairs that can't wait.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            ...
                            <a
                                href={`https://wa.me/${WHATSAPP_NUMBER.replace('+', '')}?text=${encodeURIComponent("I need emergency electrical service")}`}
                                target="_blank"
                                rel="noopener noreferrer"
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border-2 border-white/20">
                        ...
                        <div className="grid sm:grid-cols-2 gap-4">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-white font-semibold">Power Outages</p>
                                    <p className="text-white/70 text-sm">Complete or partial loss</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <CheckCircle className="w-5 h-5 text-white flex-shrink-0 mt-1" />
                                <div>
                                    <p className="text-white font-semibold">Circuit Faults</p>
                                    <p className="text-white/70 text-sm">Tripping breakers, shorts</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <CheckCircle className="w-5 h-5 text-white flex-shrink-0 mt-1" />
                                <div>
                                    <p className="text-white font-semibold">Burning Smell/Sparks</p>
                                    <p className="text-white/70 text-sm">Electrical fire hazards</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <CheckCircle className="w-5 h-5 text-white flex-shrink-0 mt-1" />
                                <div>
                                    <p className="text-white font-semibold">Safety Switch Trips</p>
                                    <p className="text-white/70 text-sm">RCD/MCB issues</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
function MultiTaskJobsSection() {
    const exampleJobs = [
        { tasks: ["Add sockets", "Install lights", "Upgrade fuse box"], total: "£650-850", saved: "£75" },
        { tasks: ["EV charger", "Outdoor socket", "Security light"], total: "£800-1100", saved: "£100" },
        { tasks: ["Rewire room", "New switches", "USB sockets"], total: "£450-600", saved: "£60" },
    ];

    return (
        <section className="bg-gradient-to-br from-rooketrade-cyan to-rooketrade-blue px-4 lg:px-8 py-16 lg:py-24">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12 lg:mb-16">
                    ...
                    {exampleJobs.map((job, idx) => (
                        <div key={idx} className="bg-white rounded-3xl p-6 shadow-xl">
                            <div className="flex items-center gap-2 mb-4">
                                <div className="w-8 h-8 bg-rooketrade-cyan rounded-full flex items-center justify-center text-slate-900 font-bold">
                                    {job.tasks.length}
                                </div>
...
export default function HandymanLanding({
    ...
    const finalHeadline = variant?.content?.heroHeadline || headline || "{{location}}||Electrical Service||Next-day slots • NICEIC registered";
            ...
            <div className="relative bg-slate-900">
                ...
                <div className="relative z-10">
                    <IntakeHero
                        ...
                        bannerText="⚡️ Fastest growing electrical services team in {{location}}"
