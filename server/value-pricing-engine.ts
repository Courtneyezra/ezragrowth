...
type UrgencyReasonType = 'low' | 'med' | 'high';
type OwnershipContextType = 'tenant' | 'homeowner' | 'landlord' | 'airbnb' | 'selling';
type DesiredTimeframeType = 'flex' | 'week' | 'asap';
type ClientType = 'residential' | 'commercial';
type JobComplexityType = 'trivial' | 'low' | 'medium' | 'high';
type SegmentType = 'BUSY_PRO' | 'PROP_MGR' | 'SMALL_BIZ' | 'DIY_DEFERRER' | 'BUDGET' | 'OLDER_WOMAN' | 'UNKNOWN';

interface ValuePricingInputs {
  ...
  jobComplexity?: JobComplexityType;
